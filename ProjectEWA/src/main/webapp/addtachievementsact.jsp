...
<%@ page session="true" %>
    ...
    PreparedStatement ps = connection.prepareStatement("insert into teacherevents"
            + "(username,designation,year,branch,dob,qualification,email,mobile,exp,specialization,subjects) values(?,?,?,?,?,?,?,?,?,?,?)");
